...
<!-- <link rel="stylesheet" type="text/css" href="../jquery-easyui-themes/ui-cupertino/easyui.css" />
	...
	var _menus = {
		"menus" : [ {
			...
			"menus" : [ {
				...
				"menuname" : "驻港企业信息审核",
				"icon" : "icon-nav",
				"url" : "../jsp/PortEnterpriseinfoA.jsp"
			}, {
				"menuid" : "22",
				"menuname" : "驻港企业相关人员查询",
				"icon" : "icon-nav",
			...
			"menus" : [ {
				...
				"menuname" : "审批历史查询",
				"icon" : "icon-nav",
				"url" : "../jsp/APRiskGoodPetsearch.jsp"
			},{
				"menuid" : "41",
				"menuname" : "审批历史统计",
				"icon" : "icon-nav",
			...
			"menus" : [ {
				...
				"menuname" : "港口工作人员管理",
				"icon" : "icon-nav",
				"url" : "../jsp/Aportworker.jsp"
			},{
				"menuid" : "31",
				"menuname" : "泊位查询管理",
				"icon" : "icon-nav",
				"url" : "/firstssm/jsp/APortBerth.jsp"
			}]
		}, {
			"menuid" : "56",
			"icon" : "icon-sys",
...
<body class="easyui-layout" style="overflow-y: hidden" scroll="no">
	...
	<!-- ================顶部====================== -->
	<div id="north" style="height:80px;" region="north" split="true" border="false">
		...
		<h1><span id="n-head-l" style="margin-top: 20px;margin-left: 30px">港口危险货物安全监管信息系统--政府用户端</span></h1>
	</div>
	...
	<div id="east" region="east" hide="true" split="true" title="导航菜单"
		...
		<div id="nav1" class="easyui-accordion" fit="true" border="false">
			<div title="动态公告栏" style="padding: 10px;">
				<div id="e-pan">
					<!-- <span><a href="constructor/a.html">首 页</a></span>
					<span><a href="constructor/a.html">交通政务</a></span> 
					<span><a href="constructor/a.html">政府服务</a></span>  -->
					<span><a href="../jsp/Notice.jsp">公 告</a></span>
				</div>
			</div>
	...
	<!--修改密码窗口-->
	<div id="w" class="easyui-window" title="修改密码" collapsible="false"icon="icon-save"
			...
			<div region="center" border="false"
				...
				<form id="grid1">
					<table>
						<tr>
							<td>原始密码：</td>
							<td><input id="Pass" name="Pass" type="password" class="txt01" /></td>
						</tr>
						<tr>
							<td>新密码：</td>
