	...
	var _menus = {
		"menus" : [ {
			...
			"menus" : [ {
				...
				"menuname" : "二轮审批",
				"icon" : "icon-nav",
				"url" : "../jsp/PRiskGoodPetsearchSecond.jsp"
			}, {
				"menuid" : "31",
				"menuname" : "紧急申报审批",
				"icon" : "icon-nav",
				"url" : "../jsp/PRiskGoodPetsearchUrgency.jsp"
			}]
		},{
			"menuid" : "28",
			"icon" : "icon-sys",
			...
			"menus" : [/*  {
				...
				"menuname" : "泊位管理",
				"icon" : "icon-nav",
				"url" : "/firstssm/jsp/PortBerth.jsp"
			}]
		},{
			"menuid" : "56",
			"icon" : "icon-sys",
...
<body class="easyui-layout" style="overflow-y: hidden" scroll="no">
	...
	<div id="north" style="height: 80px;" region="north" split="true"
		...
		<span id="n-head-r" class="head" style="margin-top: 20px">
			用户类型：现场安检员 <a href="#" id="loginuser" style="margin-left: 20px"><%=session.getAttribute("username")%></a>,欢迎您
	...
	<!--  底部 -->
	<div id="footer" region="south" split="false" style="hight: 45px;">
		...
		<div id="nav1" class="easyui-accordion" fit="true" border="false">
			<div title="相关服务" style="padding: 10px;">
				<div id="e-pan">
					...
					<span><a href="constructor/a.html">公 告</a></span>
				</div>
			</div>
	...
	<!--修改密码窗口 -->
	<div id="w" class="easyui-window" title="修改密码" collapsible="false" data-options="closed:true"icon="icon-save"
