...
<body>
	...
	<div id="detaildlg" class="easyui-dialog" title="危险货物申报详细信息"
		...
		<div class="easyui-tabs">
			...
			<div title="一轮审核" style="padding: 10px">
				<div>
					<form id="grid2" style="height: 500px;">
						<table style="margin-top: 40px; margin-bottom: 75px"
							...
							<tr>
								...
								<td><span class="radioSpan"> <input type="radio"
										name="qfcompany" style="margin-left: 20px" value="1">是</input>
										<input type="radio" name="qfcompany" value="0">否</input>
								</span></td>
							</tr>
							<tr>
								<td align="center"><label>危险品种类是否合法:</label></td>
								<td><span class="radioSpan"> <input type="radio"
										name="qfrstyle" style="margin-left: 20px" value="1">是</input>
										<input type="radio" name="qfrstyle" value="0">否</input>
								</span></td>
							</tr>
							<tr>
								<td align="center"><label>封装类型是否合格:</label></td>
								<td><span class="radioSpan"> <input type="radio"
										name="qfpack" style="margin-left: 20px" value="1">是</input> <input
										type="radio" name="qfpack" value="0">否</input>
								</span></td>
							</tr>
							<tr>
								<td align="center"><label>单次运输是否超过限重:</label></td>
								<td><span class="radioSpan"> <input type="radio"
										name="qfweight" style="margin-left: 20px" value="1">是</input>
										<input type="radio" name="qfweight" value="0">否</input>
								</span></td>
							</tr>
							<tr>
								<td align="center"><label>承运船舶是否合法:</label></td>
								<td><span class="radioSpan"> <input type="radio"
										name="qfboat" style="margin-left: 20px" value="1">是</input> <input
										type="radio" name="qfboat" value="0">否</input>
								</span></td>
							</tr>
							<tr>
								...
								<td><input class="easyui-datebox" type="text"
									...
									name="qfdate" data-options="required:true,editable:false"></input></td>
							</tr>
							<tr>
						...
						<div id="dlg-buttons" align="center">
							<a href="javascript:void(0)" class="easyui-linkbutton"
								iconCls="icon-ok" onclick="saveFirst()">提交</a>
							<a href="javascript:void(0)" class="easyui-linkbutton"
								iconCls="icon-cancel"
								onclick="javascript:$('#detaildlg').dialog('close')"
			...
			<div title="二轮审核" style="padding: 10px">
				<div>
					<form id="grid3" style="height: 500px;">
						...
						<div id="dlg-buttons" align="center">
							<a href="javascript:void(0)" class="easyui-linkbutton"
								iconCls="icon-ok" onclick="saveSecond()">提交</a>
							<a href="javascript:void(0)" class="easyui-linkbutton"
								iconCls="icon-cancel"
								onclick="javascript:$('#detaildlg').dialog('close')"
								style="width: 90px">关闭</a>
								...
								columns : [ [
										...
										},
										{
											...
											formatter : function(value, row,
													index) {
												var a = '<a href="#" class="easyui-linkbutton" style="width: 90px" onclick="detail('
														+ row.rnum
														+ ')">详细信息</a> ';
												return a ;
											}
